    ...
    private void init(){
        ...
        et_search.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                Log.e("et_search hasFocus", String.valueOf(hasFocus));
                if (hasFocus){  // 点击外面，搜索栏不消失
                    queryData(et_search.getText().toString());
                    //et_search.getText().toString()
                }
//                else {  //if(!listView.hasFocus() && !tv_clear.hasFocus())
//                    // hasFocus
//                    // TODO: 点击搜索记录的时候，记录会消失
...
//                    Toast.makeText(context, "需要搜索的是" + et_search.getText(), Toast.LENGTH_SHORT).show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                queryData(et_search.getText().toString());  // 搜索现成关键字
            }
        });
        ...
        searchBack.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context, "收起", Toast.LENGTH_SHORT).show();
            }
        });

        searchButton.setOnClickListener(new OnClickListener() {
            // 同et_search.setOnKeyListener
            @Override
            public void onClick(View v) {
                // 1. 点击搜索按键后，根据输入的搜索字段进行查询
                // 注：由于此处需求会根据自身情况不同而不同，所以具体逻辑由开发者自己实现，此处仅留出接口
...
//                    Toast.makeText(context, "需要搜索的是" + et_search.getText(), Toast.LENGTH_SHORT).show();
    ...
    public boolean ifRecordVisible() {
